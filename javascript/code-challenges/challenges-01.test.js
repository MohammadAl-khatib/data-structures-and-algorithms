...
const fizzbuzz = (arr) => {
  ...
  arr.forEach((item)=>
  {
    ...
    else if(item%5 ===0 && item%3!==0){array7.push('Buzz');}
    else if(item%3 ===0 && item%5===0){array7.push('Fizz Buzz');}
    else {array7.push(item);}
  }
  );
  return array7;
};
