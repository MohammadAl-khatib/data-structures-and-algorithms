...
const screenForNames = (arr) => {
  // Solution code here...
  return arr.filter(item=>/(^Mr.\s|^Mrs.\s|^Ms.\s|^Dr.\s)+[a-zA-Z]+[a-zA-Z]$/.test(item));
};
...
const toTitleCase = (arr) => {
  // Solution code here...
  return arr.map((item) =>
    item.replace(item.substring(0, 1), item.substring(0, 1).toUpperCase())
  );
};
...
const detectTicTacToeWin = (board) => {
  // Solution code here...
  let result = false;
  if (board [0][0] === board [0][1] && board [0][0]=== board [0][2] && board [0][0] !== ''){result = true;}
  if (board [1][0] === board [1][1] && board [1][0]=== board [1][2] && board [1][0] !== ''){result = true;}
  if (board [2][0] === board [2][1] && board [2][0]=== board [2][2] && board [2][0] !== ''){result = true;}
  if (board [0][0] === board [1][0] && board [0][0]=== board [2][0] && board [0][0] !== ''){result = true;}
  if (board [0][1] === board [1][1] && board [0][1]=== board [2][1] && board [0][1] !== ''){result = true;}
  if (board [0][2] === board [1][3] && board [0][2]=== board [2][3] && board [0][2] !== ''){result = true;}
  if (board [0][0] === board [1][1] && board [0][0]=== board [2][2] && board [0][0] !== ''){result = true;}
  if (board [0][2] === board [1][1] && board [0][2]=== board [2][0] && board [0][2] !== ''){result = true;}
  return result;
};
