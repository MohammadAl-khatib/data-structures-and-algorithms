...
const addValues = (arr) => {
  // Solution code here...
  let array = arr.reduce((sum, value) => {
    sum = sum + value;
    return sum;
  },0);
  return array;
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let result = arr.reduce((length, value,i) => {
    return i+1;
  },0);
  return result;
};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split('').reduce((first,second)=>second+first);
};
