...
const extractStats = (arr) => {
  ...
  let array=arr.map(item=>{
    ...
    object.total = item.effort + item.baseStat;
    return object;
  });
  return array;
};
